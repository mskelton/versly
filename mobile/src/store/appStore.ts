...
export const useAppStore = create<AppStore>((set, get) => ({
  ...
  loadBooks: async (translationId: string) => {
    try {
      ...
      set({ error: error instanceof Error ? error.message : 'Failed to load books' });
    }
  },
  ...
  goToNextChapter: async () => {
    ...
    try {
      ...
      set({ error: error instanceof Error ? error.message : 'Failed to go to next chapter' });
    }
  },
  ...
  goToPreviousChapter: async () => {
    ...
    try {
      ...
      set({ error: error instanceof Error ? error.message : 'Failed to go to previous chapter' });
    }
  },
  ...
  loadAvailableTranslations: async () => {
    try {
      ...
      set({ error: error instanceof Error ? error.message : 'Failed to load translations' });
    }
  },
}));
