...
fun Reader(passage: Passage) {
    ...
    Column {
        Column(
            modifier = Modifier.align(Alignment.CenterHorizontally).padding(0.dp, 0.dp, 0.dp, 40.dp)
        ) {
            Text(
        ...
        for (i in 0 until nodes.length()) {
            ...
            when (val type = node.getString(0)) {
                ...
                "cls" ->
                    ReaderChildNode(
                        node,
                        modifier = Modifier.padding(0.dp, 0.dp, 0.dp, 16.dp).align(Alignment.End),
                    )

                "pmo",
                "pmc" ->
                    ReaderChildNode(node, modifier = Modifier.padding(16.dp, 0.dp, 0.dp, 16.dp))
                ...
                "pmr" ->
                    ReaderChildNode(
                        node,
                        modifier = Modifier.padding(16.dp, 0.dp, 0.dp, 16.dp).align(Alignment.End),
                    )
